...
Dos de los sistemas operativos más populares para dispositivos móviles son Android y Apple iOS. Los dispositivos móviles están programados para usar una red Wi-Fi para Internet, si hay una disponible, y el dispositivo puede conectarse al punto de acceso y recibir una dirección IP. Si no hay ninguna red WiFi disponible, el dispositivo usa la funcionalidad de datos celulares, si está configurada.
...
Además de un router integrado, hay muchos tipos diferentes de dispositivos que pueden conectarse a una red doméstica, por ejemplo, computadores de escritorio, sistemas de juegos, sistemas de televisión inteligente, impresoras, escáneres, cámaras de seguridad y dispositivos de control de temperatura.
